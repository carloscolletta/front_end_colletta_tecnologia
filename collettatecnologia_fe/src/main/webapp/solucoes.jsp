...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="./metodologia.jsp"" target="blank" class="paginas">Metodologias<span class="sr-only">(PÃ¡gina atual)</span></a>
            </li>
    ...
    <section class="container">        
        ...
        <div class="grid_colletta">        
            <div class="box menu">
                <span>SOLUÃÃES ONDE ATUAMOS</span>
                <span></span>
                <br>
            </div>       
        </div>
        ...
        <div class="grid_paginas"> 
            ...
            <div class="solucoesl">
              <img src="./img/areas.png" class="solucoes_fluid" >
            </div>
