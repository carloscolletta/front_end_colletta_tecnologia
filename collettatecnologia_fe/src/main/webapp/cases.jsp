...
<body>
    ...
    <section class="container">        
        ...
        <div class="grid_colletta">        
            <div class="box menu">
                <span></span>
                <!-- <span>&nbsp &nbsp &nbsp Diga nÃ£o ao abandono.</span> -->
            </div>       
        </div>
        ...
        <div class="grid_paginas"> 
         ...
         <div class="metodo1">
            <img src="./img/dinamica.png" class="negocios_fluid" >
         </div>

         <div class="prin_textm1">         
              <text class="texto">
                  <span> Desenvolvemos um projeto de Back to Standard dp sistema Protheus. Onde revisamos todo 
                         o processo, provocando assim uma grande reestruturaÃ§Ã£o. Implememtando assim o processo
                         com GestÃ£o de ServiÃ§os, TMS e WMS. Implementando o uso de coletores na operaÃ§Ã£o
                  </span>
                  <br>
              </text>
         ...
         <div class="prin_textm2">         
            <text class="texto">
              <span> Fomos contratado para a implentaÃ§Ã£o do mÃ³dulo SIGALOGA para assim integrarmos as vendas 
                de botijÃµes de gas direto ao consumidor na portaria da empresa, integrando com contas a receber, 
         ...
         <div class="metodo2">
           <img src="./img/servgas.png" class="negocios_fluid" >
         </div>
