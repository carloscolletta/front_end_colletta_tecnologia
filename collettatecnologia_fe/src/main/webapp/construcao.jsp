...
<body>
    ...
    <section class="container">        
        ...
        <div class="grid_paginas"> 
            ...
            <div class="principal">
              <img src="./img/construcao.png" class="construcao_fluid" >
            </div>
    
            <div class="prin_text">         
              <text class="texto">
                  <span> NÃ³s da COLLETTA TECHNOLOGY estamos emrpenhados em trazer
                    novidades e transformaÃ§Ã£o digital para nossso clientes - AGUARDEM!
                  </span>
                  <br>
              </text>
